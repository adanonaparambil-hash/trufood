...
function HeroSection() {
  ...
  return (
    <div ref={ref} className="relative w-full overflow-hidden" style={{ height: '92vh', minHeight: '580px' }}>
      ...
      {/* Gradient overlays */}
      <div className="absolute inset-0" style={{ background: 'linear-gradient(160deg, rgba(5,7,5,0.82) 0%, rgba(5,7,5,0.4) 55%, rgba(5,7,5,0.7) 100%)' }} />
      <div className="absolute inset-x-0 bottom-0 h-56" style={{ background: 'linear-gradient(to top, #050705 0%, transparent 100%)' }} />
      <div className="absolute inset-x-0 top-0 h-36" style={{ background: 'linear-gradient(to bottom, rgba(5,7,5,0.6) 0%, transparent 100%)' }} />
